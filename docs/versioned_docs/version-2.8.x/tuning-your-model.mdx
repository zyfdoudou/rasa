...
```yaml-rasa (versioned_docs/version-2.8.x/sources/data/configs_for_docs/default_spacy_config.yml)
```
...
```yaml-rasa (versioned_docs/version-2.8.x/sources/data/configs_for_docs/default_config.yml)
```
...
```yaml-rasa (versioned_docs/version-2.8.x/sources/data/configs_for_docs/config_featurizers.yml)
```
